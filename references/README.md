...
当前 MVP2 的主参考是 `reticle` 和 `snapclip`：前者提供冻结画面/框选/标注交互参考，后者解决 GNOME Wayland 截图快门声问题。本项目使用 Flutter + Rust 重写，不移植 Swift/AppKit/Python/GTK 实现。发布流程见 [`docs/packaging.md`](../docs/packaging.md)。
