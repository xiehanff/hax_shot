...
| — | [MVP 参考结论](./reference-decisions.md) | — | 将 macOS 设计转换为 HaxShot 的 Flutter + Rust + Linux 方案 |
...
| — | [HaxShot AI](./ai.md) | 截图视觉 AI、对话侧栏和 DeepSeek 流式请求 |

## 结论先看

HaxShot 当前包含基础截图、自启动、矩形/箭头/文字标注，以及截图视觉 AI；MVP2 的标注细节见 [MVP2 功能说明](./mvp2.md)，AI 细节见 [HaxShot AI](./ai.md)。
...
- HaxShot 源代码：MIT，见根目录 [`LICENSE`](../LICENSE)；当前应用图标来自外部 `.icns` 资源。
